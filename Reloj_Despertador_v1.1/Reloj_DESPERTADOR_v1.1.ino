...
# *                                                    * #
# *         Versión v1.1  Fecha: 04/06/2016            * #
# ****************************************************** #
##########################################################
*/

#define __VERSION__ "Reloj Despertador v1.1\n"
...
//========================================================
//  FUNCION PARA MOSTAR LA HORA PROGRAMADA PARA ALARMA
//========================================================
...
void modificarHoraIndicada(byte HORA, byte MINUTO, boolean ALARMA)
{
  ...
  if (ALARMA == true){ 
    /* Siestamos modificando ALARMA, mostrar su estado actual */ 
    if (FLAG_alarmaON == true){ 
      lcd.setCursor(15, 0); 
      lcd.print("O");
      lcd.setCursor(15, 1);
  ...
  while (modo_PROGRAMACION == true){
    ...
    if (lectura == 'B' AND ALARMA == true){
      FLAG_alarmaON = !FLAG_alarmaON;
      modo_PROGRAMACION = false;
